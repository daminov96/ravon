...
from .models import CustomUser, Cashilok, CashilokFill
from django.utils import timezone
from .permissions import IsSelf
from .serializers import *
from ..app.models import *
from ..utils.utils import sendsms, invalidate_verification_code
    ...
    def post(self, request, *args, **kwargs):
        ...
        if username and code:
            ...
            if user:
                ...
                return Response({"error": "Verification code is not sent or expired!"},
